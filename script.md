...
(Very similar to a CallScript, but with some extra features for working with Maps/Zones.)
  ...
  * required - if true this Interaction will automaticall be run when the player enters the room. If there
    are multiple 'required' Interactions, they will be run in the order they are defined.
